#
#  Be sure to run `pod spec lint SCMoveView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Stefen"
  # s.authors            = { "Stefen" => "1828850812@qq.com" }
  # s.social_media_url   = "http://twitter.com/Stefen"
